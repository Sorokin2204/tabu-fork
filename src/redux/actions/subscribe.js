    ...
    try {
      ...
      axios
        ...
        .catch((error) => {
          ...
          dispatch(subscribeError(errorMessage ? { title: errorMessage, desc: 'Попробуйте ввести другую почту' } : { title: 'Извините, произошла неожидонная ошибка', desc: 'Повторите позже' }));
