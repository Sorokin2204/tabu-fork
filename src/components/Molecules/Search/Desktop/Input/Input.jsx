...
import { getCategories, getSearchProducts, searchCategories } from 'redux/actions/search';
import { setSearchText } from 'redux/reducers/searchReducer';
    ...
    <S.Wrapper>
      <S.Container>
        <S.Subcont>
          ...
          <S.Input value={search} onChange={(e) => setSearch(e.target.value)} spellcheck="false" />
