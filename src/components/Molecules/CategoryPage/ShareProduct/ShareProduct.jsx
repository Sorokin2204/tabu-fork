              ...
              <S.Input>
                ...
                <S.InputCopy
                  ...
                  {!copy ? (
                    ...
                    <svg style={{ transform: 'scale(1.7)', height: '24px' }} width="12" height="9" viewBox="0 0 12 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path
                        fillRule="evenodd"
                        clipRule="evenodd"
                        d="M11.4401 0.112807C11.6148 0.272969 11.6266 0.544446 11.4664 0.719168L4.38518 8.44417C4.30389 8.53285 4.18912 8.58334 4.06882 8.58334C3.94852 8.58334 3.83374 8.53285 3.75246 8.44417L0.533706 4.9328C0.373544 4.75808 0.385347 4.48661 0.560069 4.32644C0.734791 4.16628 1.00627 4.17809 1.16643 4.35281L4.06882 7.51905L10.8337 0.139171C10.9939 -0.0355512 11.2653 -0.0473545 11.4401 0.112807Z"
                        fill="#1F1F1F"
                      />
                    </svg>
                  )}
