    ...
    <S.Container>
      ...
      <S.Columns>
        ...
        <S.RightColumn>
          ...
          <S.ValueRow>{openedProduct ? (openedProduct.color ? openedProduct.color.title : '') : ''}</S.ValueRow> <S.ValueRow>{openedProduct ? (openedProduct?.condition_name ? openedProduct?.condition_name : '') : ''}</S.ValueRow>
        </S.RightColumn>
      </S.Columns>
    </S.Container>
  );
