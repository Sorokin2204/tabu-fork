...
const Instagram = () => {
  ...
  return (
    <Grid padding="0 0 160px 0" margin="0 0 0 0">
      <Text color="#191919" fontFamily="Gilroy" fontWeight="400" fontSize="32px" textAlign="center" textTransform="uppercase">
        Наш инстаграм
      </Text>
      <Grid name="Gallery" margin="64px 0 0 0" columns="1fr 1fr" gap="2px" height="612px !important">
        <Grid name="Left" columns="2fr 1fr" gap="2px">
            ...
            <InstIcon>
              <svg width={22} height={22} viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                  ...
                  fill="#191919"
                />
                <path d="M17.0002 6.33337C17.3684 6.33337 17.6668 6.0349 17.6668 5.66671C17.6668 5.29852 17.3684 5.00004 17.0002 5.00004C16.632 5.00004 16.3335 5.29852 16.3335 5.66671C16.3335 6.0349 16.632 6.33337 17.0002 6.33337Z" fill="#191919" />
                <path
                  fillRule="evenodd"
                  clipRule="evenodd"
          ...
          <Grid gap="2px">
              ...
              <InstIcon>
                <svg width={22} height={22} viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
                    ...
                    fill="white"
                  />
                  <path d="M17.0002 6.33337C17.3684 6.33337 17.6668 6.0349 17.6668 5.66671C17.6668 5.29852 17.3684 5.00004 17.0002 5.00004C16.632 5.00004 16.3335 5.29852 16.3335 5.66671C16.3335 6.0349 16.632 6.33337 17.0002 6.33337Z" fill="white" />
                  <path
                    fillRule="evenodd"
                    clipRule="evenodd"
                    d="M6.3335 0.333374C3.01979 0.333374 0.333496 3.01967 0.333496 6.33337V15.6667C0.333496 18.9804 3.01979 21.6667 6.3335 21.6667H15.6668C18.9805 21.6667 21.6668 18.9804 21.6668 15.6667V6.33337C21.6668 3.01967 18.9805 0.333374 15.6668 0.333374H6.3335ZM15.6668 1.66671H6.3335C3.75617 1.66671 1.66683 3.75605 1.66683 6.33337V15.6667C1.66683 18.244 3.75617 20.3334 6.3335 20.3334H15.6668C18.2442 20.3334 20.3335 18.244 20.3335 15.6667V6.33337C20.3335 3.75605 18.2442 1.66671 15.6668 1.66671Z"
            ...
            <DivImage backgroundSize="cover" backgroundPosition="center 0%" src={ad[2]?.image} onClick={() => window.open(ad[2]?.link, '_blank')}>
              <InstIcon>
                <svg width={22} height={22} viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
                    fillRule="evenodd"
