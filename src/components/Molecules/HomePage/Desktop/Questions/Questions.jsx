...
перечислены продавцу только после того, как товар попадет к вам."
        />
        <Question title="Сколько времени занимает доставка? " description="По городу Алматы доставка занимает около 7 рабочих дней. Доставка может занять больше времени в другие города Казахстана." />
        <Question
