...
const Right = () => {
  return (
    <S.Right>
      ...
      <S.DefaultText marginTop="19px">Доставка UPS, DHL, Fedex или Colissimo.</S.DefaultText>

      <S.TitleText marginTop="40px">ДОСТАВКА</S.TitleText>

      <S.DefaultText marginTop="19px">Вашему продавцу будет предложено быстро отправить ваш товар. Мы постараемся, чтобы сроки доставки были как можно короче. Если вы купили товар у доверенного или экспертного продавца, у него есть 5 дней на отправку.</S.DefaultText>

      <S.TitleText marginTop="40px">НЕ удовлетворены?</S.TitleText>

      <S.DefaultText marginTop="19px">Перерегистрируйте свой товар в течение 72 часов! Это просто и без комиссии.</S.DefaultText>
    </S.Right>
  );
};
