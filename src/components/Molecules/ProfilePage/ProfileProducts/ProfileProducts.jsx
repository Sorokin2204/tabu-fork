...
const ProfileProducts = () => {
  const product = {
    ...
    seller: {
      id: 1,
      password: 'pbkdf2_sha256$260000$XiJF7uAZjgmkh86kv76h3p$M26B7KyeGmfsR8t1VrGN/iSq18rlhm7w89Yk1uKbysw=',
    ...
    condition_images: [
      {
        id: 6,
        main_image: true,
        image: '/media/images/%D0%B1%D0%B0%D0%B1%D0%B8%D0%B4%D0%B6%D0%BE%D0%BD.jpg',
      },
      {
        id: 11,
        main_image: false,
  ...
  return (
    <S.Wrapper>
      {isMobile ? (
        <>
          <MobileCartProductCard product={product} />
          <MobileCartProductCard product={product} />
        </>
      ) : (
        <>
