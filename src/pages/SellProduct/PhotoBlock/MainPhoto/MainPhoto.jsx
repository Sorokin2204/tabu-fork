  ...
  return (
    <S.Wrapper {...props}>
      <S.MainPhoto
        ...
        background={preview}
        style={{
          backgroundColor: preview ? '#f6f6f9' : 'none',
          backgroundSize: '80%',
          border: preview ? 'none' : '1px dashed rgba(0, 0, 0, 0.1)',
        }}>
        {!uploadedFile && !preview && (
          <svg width={45} height={33} viewBox="0 0 45 33" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path
              ...
              fill="#E5E5E5"
            />
            <path d="M4.59856 1.97232C4.59856 1.42394 5.04472 0.979399 5.59508 0.979399H9.58762C10.138 0.979399 10.5841 1.42394 10.5841 1.97232C10.5841 2.52069 10.138 2.96524 9.58762 2.96524H5.59508C5.04472 2.96524 4.59856 2.52069 4.59856 1.97232Z" fill="#E5E5E5" />
          </svg>
        )}
      </S.MainPhoto>
