    ...
    <S.Wrapper>
      ...
      <S.Variants>
        ...
        <S.Variant onClick={() => setValue(name, 2)}>
          ...
          <S.VariantDescription>Вещь бывшая в употреблении, за которой хорошо ухаживали. Возможны небольшие дефекты в виде сколов, царапинок, дырочек и зацепок.</S.VariantDescription>
        </S.Variant>
      </S.Variants>
    </S.Wrapper>
  );
